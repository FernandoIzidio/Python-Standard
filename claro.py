...
def sleep_wireless(status:bool) -> None:
    ...
    if status:
        for ip_index in range(1, 10):
            ...
            sleep_time = browser.find_element(By.XPATH, '/html/body/div[2]/div/div[2]/div/div/form/div[10]/div/div/select')
            sleep_time.click()    
            
            activeopt = browser.find_element(By.XPATH, '/html/body/div[2]/div/div[2]/div/div/form/div[10]/div/div/select/option[2]')
            activeopt.click()
            submit_config = browser.find_element(By.XPATH, '/html/body/div[2]/div/div[2]/div/div/form/div[11]/button/div')
            submit_config.click()
        ...
        for ip_index in range(1, 10):   
            ...
            activeopt = browser.find_element(By.XPATH, '/html/body/div[2]/div/div[2]/div/div/form/div[10]/div/div/select/option[3]')
            activeopt.click()
            submit_config = browser.find_element(By.XPATH, '/html/body/div[2]/div/div[2]/div/div/form/div[11]/button/div')
            submit_config.click()
